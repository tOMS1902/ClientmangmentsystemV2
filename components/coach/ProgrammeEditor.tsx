...
export function ProgrammeEditor({ clientId, initialProgramme }: ProgrammeEditorProps) {
  ...
  function addDay() {
    ...
    const newDay: ProgrammeDay = {
      ...
      day_number: programme.days.length + 1,
      day_label: `Day ${programme.days.length + 1}`,
      sort_order: programme.days.length + 1,
      exercises: [],
    }
    setProgramme({ ...programme, days: [...programme.days, newDay] })
  }
